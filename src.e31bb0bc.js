...
var author$project$Image$empty = author$project$Image$Image(_List_Nil);
var author$project$Main$NoOp = {$: 'NoOp'};
var author$project$Main$RemoveNotification = function (a) {
	return {$: 'RemoveNotification', a: a};
};
var author$project$Main$SetImageViewSize = function (a) {
	return {$: 'SetImageViewSize', a: a};
};
var author$project$Main$ViewBox = F4(
	function (x, y, width, height) {
		return {height: height, width: width, x: x, y: y};
	});
var author$project$Main$Flags = F2(
	function (repositoryUrl, title) {
		return {repositoryUrl: repositoryUrl, title: title};
	});
...
var author$project$Main$decodeFlags = elm$json$Json$Decode$decodeValue(
	A3(
		elm$json$Json$Decode$map2,
		author$project$Main$Flags,
		A2(elm$json$Json$Decode$field, 'repositoryUrl', elm$json$Json$Decode$string),
		A2(elm$json$Json$Decode$field, 'title', elm$json$Json$Decode$string)));
var author$project$Main$defaultFlags = A2(author$project$Main$Flags, '', '');
var author$project$Notification$Danger = {$: 'Danger'};
var author$project$Notification$Info = {$: 'Info'};
var author$project$Notification$Notification = F3(
	function (id, priority, message) {
		return {id: id, message: message, priority: priority};
	});
...
var author$project$Notification$add = F4(
	function (msg, priority, message, manager) {
		var id = manager.lastNotificationId + 1;
		var cmd = function () {
			switch (priority.$) {
				case 'Success':
					return A2(
		...
		return _Utils_Tuple2(
			_Utils_update(
				manager,
				{
					...
					notifications: A2(
						elm$core$List$cons,
						A3(author$project$Notification$Notification, id, priority, message),
						manager.notifications)
				}),
			cmd);
	});
var author$project$Notification$empty = {lastNotificationId: 0, notifications: _List_Nil};
...
var author$project$Main$init = function (flags) {
	var _n0 = function () {
		var _n1 = author$project$Main$decodeFlags(flags);
		if (_n1.$ === 'Ok') {
			var decoded = _n1.a;
			return _Utils_Tuple2(decoded, elm$core$Maybe$Nothing);
		} else {
			var error = _n1.a;
			return _Utils_Tuple2(
				author$project$Main$defaultFlags,
				elm$core$Maybe$Just(error));
		}
	}();
	var decodedFlags = _n0.a;
	var decodeError = _n0.b;
	var _n2 = A3(
		elm$core$Basics$apR,
		A2(
			elm$core$Maybe$map,
			A2(
				...
				A2(author$project$Notification$add, author$project$Main$RemoveNotification, author$project$Notification$Danger)),
			decodeError),
		elm$core$Maybe$withDefault(
			A3(author$project$Notification$add, author$project$Main$RemoveNotification, author$project$Notification$Info, 'Hello, world!')),
		author$project$Notification$empty);
	var notifications = _n2.a;
	var cmd = _n2.b;
	var model = {
		flags: decodedFlags,
		image: author$project$Image$empty,
		lastNotificationId: 0,
		modal: {codelSize: 1, file: elm$core$Maybe$Nothing, isActive: false, isDecoding: false},
		mouseOperation: author$project$Main$NoOp,
		notifications: notifications,
		offset: _Utils_Tuple2(0.0, 0.0),
		scale: 1.0,
		viewBox: A4(author$project$Main$ViewBox, 0.0, 0.0, 0.0, 0.0)
	};
	return _Utils_Tuple2(
		model,
		elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					...
					author$project$Main$SetImageViewSize,
					elm$browser$Browser$Dom$getElement('imageView')),
					cmd
				])));
};
var author$project$Main$AddNotification = F2(
	function (a, b) {
		return {$: 'AddNotification', a: a, b: b};
	});
var author$project$Main$ImageDecoded = function (a) {
	return {$: 'ImageDecoded', a: a};
};
var author$project$Ports$error = _Platform_incomingPort('error', elm$json$Json$Decode$string);
var author$project$Ports$imageDecoded = _Platform_incomingPort('imageDecoded', elm$json$Json$Decode$value);
var elm$core$Platform$Sub$batch = _Platform_batch;
var author$project$Main$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				author$project$Ports$imageDecoded(author$project$Main$ImageDecoded),
				author$project$Ports$error(
				author$project$Main$AddNotification(author$project$Notification$Danger))
			]));
};
var author$project$Image$ImageData = F3(
...
var author$project$Image$Codel = F2(
	function (point, rgb) {
		return {point: point, rgb: rgb};
	});
var author$project$Image$ColorBlock = F4(
	function (color, area, codels, table) {
		return {area: area, codels: codels, color: color, table: table};
	});
var author$project$Image$Table = F8(
	function (rl, rr, dl, dr, ll, lr, ul, ur) {
		return {dl: dl, dr: dr, ll: ll, lr: lr, rl: rl, rr: rr, ul: ul, ur: ur};
	});
...
var author$project$Image$generateTable = function (colorBlock) {
	...
	var lowerEdge = A2(
		...
		A2(
			...
			elm$core$Basics$eq(yMax)),
		colorBlock);
	var dl = A2(
		elm$core$Maybe$withDefault,
		A2(author$project$Point$Point, 0, 0),
		A2(
	...
	var lr = A2(
		...
		A2(
			...
			leftEdge));
	return A8(author$project$Image$Table, rl, rr, dl, dr, ll, lr, ul, ur);
};
var author$project$Color$Black = {$: 'Black'};
var author$project$Color$Blue = {$: 'Blue'};
var author$project$Color$Chromatic = F2(
	function (a, b) {
		return {$: 'Chromatic', a: a, b: b};
	});
...
var author$project$Color$Magenta = {$: 'Magenta'};
var author$project$Color$Normal = {$: 'Normal'};
var author$project$Color$Red = {$: 'Red'};
var author$project$Color$Unknown = function (a) {
	return {$: 'Unknown', a: a};
};
var author$project$Color$White = {$: 'White'};
var author$project$Color$Yellow = {$: 'Yellow'};
var author$project$Color$fromRgb = function (_n0) {
	var r = _n0.r;
	var g = _n0.g;
	var b = _n0.b;
	var _n1 = _Utils_Tuple3(r, g, b);
	_n1$20:
	while (true) {
		switch (_n1.a) {
			case 255:
				switch (_n1.b) {
					case 192:
						switch (_n1.c) {
							case 192:
								return A2(author$project$Color$Chromatic, author$project$Color$Light, author$project$Color$Red);
							case 255:
								return A2(author$project$Color$Chromatic, author$project$Color$Light, author$project$Color$Magenta);
							default:
								break _n1$20;
						}
					case 255:
						switch (_n1.c) {
							...
							case 192:
								return A2(author$project$Color$Chromatic, author$project$Color$Light, author$project$Color$Yellow);
							case 0:
								return A2(author$project$Color$Chromatic, author$project$Color$Normal, author$project$Color$Yellow);
							default:
								break _n1$20;
						}
					case 0:
						switch (_n1.c) {
							case 0:
								return A2(author$project$Color$Chromatic, author$project$Color$Normal, author$project$Color$Red);
							case 255:
								return A2(author$project$Color$Chromatic, author$project$Color$Normal, author$project$Color$Magenta);
							default:
								break _n1$20;
						}
					default:
			...
			case 0:
				switch (_n1.b) {
					case 255:
						switch (_n1.c) {
							case 0:
								return A2(author$project$Color$Chromatic, author$project$Color$Normal, author$project$Color$Green);
							case 255:
								return A2(author$project$Color$Chromatic, author$project$Color$Normal, author$project$Color$Cyan);
							default:
								break _n1$20;
						}
					case 192:
						switch (_n1.c) {
							case 0:
								return A2(author$project$Color$Chromatic, author$project$Color$Dark, author$project$Color$Green);
							case 192:
								return A2(author$project$Color$Chromatic, author$project$Color$Dark, author$project$Color$Cyan);
							default:
								break _n1$20;
						}
					case 0:
						switch (_n1.c) {
							case 0:
								return author$project$Color$Black;
							case 255:
								return A2(author$project$Color$Chromatic, author$project$Color$Normal, author$project$Color$Blue);
							case 192:
								return A2(author$project$Color$Chromatic, author$project$Color$Dark, author$project$Color$Blue);
							default:
								break _n1$20;
						}
					default:
			...
			case 192:
				switch (_n1.b) {
					case 255:
						switch (_n1.c) {
							case 192:
								return A2(author$project$Color$Chromatic, author$project$Color$Light, author$project$Color$Green);
							case 255:
								return A2(author$project$Color$Chromatic, author$project$Color$Light, author$project$Color$Cyan);
							default:
								break _n1$20;
						}
					case 192:
						switch (_n1.c) {
							case 255:
								return A2(author$project$Color$Chromatic, author$project$Color$Light, author$project$Color$Blue);
							case 0:
								return A2(author$project$Color$Chromatic, author$project$Color$Dark, author$project$Color$Yellow);
							default:
								break _n1$20;
						}
					case 0:
						switch (_n1.c) {
							case 0:
								return A2(author$project$Color$Chromatic, author$project$Color$Dark, author$project$Color$Red);
							case 192:
								return A2(author$project$Color$Chromatic, author$project$Color$Dark, author$project$Color$Magenta);
							default:
								break _n1$20;
						}
					default:
	...
	return author$project$Color$Unknown(
		A3(author$project$Color$Rgb, r, g, b));
};
...
var author$project$Image$partitionCodels = function (codels) {
	var newPair = F2(
	...
	var isMemberOf = F2(
		function (codel, _n2) {
			...
			return _Utils_eq(
				color,
				author$project$Color$fromRgb(codel.rgb)) && A2(
				elm$core$List$any,
				A2(
					elm$core$Basics$composeL,
					elm$core$Basics$eq(1),
					author$project$Point$distance(codel.point)),
				points);
		});
	var updatePair = F2(
		function (codel, _n1) {
			...
			return A2(
				isMemberOf,
				codel,
				_Utils_Tuple2(color, points)) ? _Utils_Tuple2(
				color,
				A2(elm$core$List$cons, codel.point, points)) : _Utils_Tuple2(color, points);
		});
	var helper = F2(
		function (codels_, result) {
			helper:
			while (true) {
				if (codels_.b) {
					var head = codels_.a;
					...
					var nextResult = A2(
						...
						A2(
							newPair,
							author$project$Color$fromRgb(head.rgb),
							head.point),
						result);
					var $temp$codels_ = tail,
						$temp$result = nextResult;
					codels_ = $temp$codels_;
					result = $temp$result;
					continue helper;
				} else {
					return result;
	...
	return A2(helper, codels, _List_Nil);
};
var elm$core$Debug$todo = _Debug_todo;
var author$project$Image$colorBlocksFromCodels = function (codels) {
	return A2(
		elm$core$List$map,
		function (_n0) {
			var color = _n0.a;
			var points = _n0.b;
			var table = author$project$Image$generateTable(points);
			var area = elm$core$List$length(points);
			return A4(author$project$Image$ColorBlock, color, area, points, table);
		},
		author$project$Image$partitionCodels(
			A2(
				_Debug_todo(
					'Image',
					{
...
var author$project$Image$imageFromImageData = F2(
	function (codelSize, initialImageData) {
		var helper = F3(
			function (imageData, i, result) {
				helper:
				while (true) {
					var _n0 = imageData.data;
					if (((_n0.b && _n0.b.b) && _n0.b.b.b) && _n0.b.b.b.b) {
						...
						var _n3 = _n2.b;
						var rest = _n3.b;
						var width = (imageData.width / codelSize) | 0;
						var x = A2(elm$core$Basics$modBy, width, i);
						var y = (i / width) | 0;
						var skip = _Utils_eq(x, width - 1) ? (((codelSize - 1) * (imageData.width + 1)) * 4) : ((codelSize - 1) * 4);
						var $temp$imageData = _Utils_update(
							imageData,
							{
								data: A2(elm$core$List$drop, skip, rest)
							}),
							$temp$i = i + 1,
							$temp$result = A2(
							elm$core$List$cons,
							A2(
								author$project$Image$Codel,
		...
		return author$project$Image$Image(
			author$project$Image$colorBlocksFromCodels(
				A3(helper, initialImageData, 0, _List_Nil)));
	});
var elm$json$Json$Decode$int = _Json_decodeInt;
var author$project$Image$decoder = function (codelSize) {
	return A2(
		elm$json$Json$Decode$map,
		author$project$Image$imageFromImageData(codelSize),
		A4(
			elm$json$Json$Decode$map3,
			author$project$Image$ImageData,
...
var author$project$Main$UrlEncoded = function (a) {
	return {$: 'UrlEncoded', a: a};
};
var author$project$Main$activateModal = function (modal) {
	return _Utils_update(
		modal,
		{isActive: true});
};
var author$project$Main$deactivateModal = function (modal) {
	return _Utils_update(
		modal,
		{isActive: false});
};
...
var author$project$Main$openFileDialog = A2(
	elm$file$File$Select$file,
	_List_fromArray(
		['image/*']),
	author$project$Main$FileSelected);
var author$project$Main$setCodelSize = F2(
	function (codelSize, modal) {
		return _Utils_update(
			modal,
			{codelSize: codelSize});
	});
var author$project$Main$setDecoding = function (modal) {
	return _Utils_update(
		modal,
		{isDecoding: true});
};
var author$project$Main$setFile = F2(
	function (file, modal) {
		return _Utils_update(
			modal,
			{
...
var author$project$Main$unsetDecoding = function (modal) {
	return _Utils_update(
		modal,
		{isDecoding: false});
};
var author$project$Notification$remove = F2(
	function (id, manager) {
		return _Utils_update(
			manager,
			{
...
var author$project$Ports$decodeImage = _Platform_outgoingPort('decodeImage', elm$json$Json$Encode$string);
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'OpenFileDialog':
				return _Utils_Tuple2(model, author$project$Main$openFileDialog);
			case 'FileSelected':
				var file = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							modal: A2(author$project$Main$setFile, file, model.modal)
						}),
					elm$core$Platform$Cmd$none);
			case 'OpenFile':
				var file = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							modal: author$project$Main$setDecoding(model.modal)
						}),
					A2(
						elm$core$Task$perform,
						author$project$Main$UrlEncoded,
						elm$file$File$toUrl(file)));
			case 'UrlEncoded':
				var url = msg.a;
				return _Utils_Tuple2(
					model,
					author$project$Ports$decodeImage(url));
			case 'ImageDecoded':
				var value = msg.a;
				var _n1 = A2(
					elm$json$Json$Decode$decodeValue,
					author$project$Image$decoder(model.modal.codelSize),
					value);
				if (_n1.$ === 'Ok') {
					var image = _n1.a;
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								image: image,
								modal: author$project$Main$unsetDecoding(
									author$project$Main$deactivateModal(model.modal))
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var message = _n1.a;
					var _n2 = A4(
						author$project$Notification$add,
						author$project$Main$RemoveNotification,
						author$project$Notification$Danger,
			...
			case 'MouseDown':
				var clientPos = msg.a.clientPos;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							mouseOperation: author$project$Main$Drag(
								{from: clientPos, to: clientPos})
						}),
					elm$core$Platform$Cmd$none);
			case 'MouseUp':
				return _Utils_Tuple2(
			...
			case 'MouseMove':
				...
				if (_n3.$ === 'NoOp') {
					...
					var xFrom = _n5.a;
					var yFrom = _n5.b;
					var _n6 = _Utils_Tuple2(xTo - xFrom, yTo - yFrom);
					var dx = _n6.a;
					var dy = _n6.b;
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								mouseOperation: author$project$Main$Drag(
									{from: to, to: clientPos}),
								offset: A3(
									elm$core$Tuple$mapBoth,
									elm$core$Basics$add((dx / model.scale) / 2),
									elm$core$Basics$add((dy / model.scale) / 2),
									model.offset)
							}),
						elm$core$Platform$Cmd$none);
				}
			case 'Wheel':
				var deltaY = msg.a.deltaY;
				var n = (deltaY < 0) ? 0.1 : (-0.1);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							scale: model.scale * A2(elm$core$Basics$pow, elm$core$Basics$e, n)
						}),
					elm$core$Platform$Cmd$none);
				...
				var size = function () {
					if (result.$ === 'Ok') {
						...
						return _Debug_todo(
							'Main',
							{
								start: {line: 470, column: 29},
								end: {line: 470, column: 39}
							})('handle error: ' + error);
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							viewBox: A4(author$project$Main$ViewBox, 0.0, 0.0, size, size)
						}),
					elm$core$Platform$Cmd$none);
			case 'AddNotification':
				var priority = msg.a;
				var message = msg.b;
				var _n8 = A4(author$project$Notification$add, author$project$Main$RemoveNotification, priority, message, model.notifications);
				var notifications = _n8.a;
				var cmd = _n8.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'RemoveNotification':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							notifications: A2(author$project$Notification$remove, id, model.notifications)
						}),
					elm$core$Platform$Cmd$none);
			case 'ActivateModal':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							modal: author$project$Main$activateModal(model.modal)
						}),
					author$project$Main$openFileDialog);
			case 'DeactivateModal':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							modal: author$project$Main$deactivateModal(model.modal)
						}),
					elm$core$Platform$Cmd$none);
			default:
				var value = msg.a;
				var _n9 = elm$core$String$toInt(value);
				if (_n9.$ === 'Just') {
					var codelSize = _n9.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								modal: A2(author$project$Main$setCodelSize, codelSize, model.modal)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
...
var author$project$Bulma$builder = F2(
	function (element, attributes) {
		return A2(
			elm$core$Basics$composeL,
			element,
			elm$core$List$append(attributes));
	});
var author$project$Bulma$box = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('box')
		]));
var author$project$Bulma$button = A2(
	author$project$Bulma$builder,
	elm$html$Html$button,
	_List_fromArray(
		[
...
var author$project$Bulma$buttons = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Bulma$column = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Bulma$columns = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Bulma$container = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Bulma$section = A2(
	author$project$Bulma$builder,
...
var author$project$Main$ActivateModal = {$: 'ActivateModal'};
var author$project$Bulma$control = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Bulma$field = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Bulma$fieldBody = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Bulma$fieldLabel = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Bulma$file = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Bulma$fileCta = A2(
	author$project$Bulma$builder,
	elm$html$Html$span,
	_List_fromArray(
		[
...
var author$project$Bulma$fileIcon = A2(
	author$project$Bulma$builder,
	elm$html$Html$span,
	_List_fromArray(
		[
...
var author$project$Bulma$fileLabel = F3(
	function (func, attributes, elements) {
		return A2(
			func,
			A2(
				elm$core$List$cons,
...
var author$project$Bulma$fileName = A2(
	author$project$Bulma$builder,
	elm$html$Html$span,
	_List_fromArray(
		[
...
var author$project$Bulma$hasName = 'has-name';
var elm$html$Html$input = _VirtualDom_node('input');
var author$project$Bulma$input = A2(
	author$project$Bulma$builder,
	elm$html$Html$input,
	_List_fromArray(
		[
...
var author$project$Bulma$isActive = 'is-active';
var author$project$Bulma$isHorizontal = 'is-horizontal';
var author$project$Bulma$isLoading = 'is-loading';
var author$project$Bulma$isPrimary = 'is-primary';
var elm$html$Html$label = _VirtualDom_node('label');
var author$project$Bulma$label = A2(
	author$project$Bulma$builder,
	elm$html$Html$label,
	_List_fromArray(
		[
...
var author$project$Bulma$modal = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Bulma$modalBackground = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Bulma$modalClose = A2(
	author$project$Bulma$builder,
	elm$html$Html$button,
	_List_fromArray(
		[
...
var author$project$Bulma$modalContent = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Main$DeactivateModal = {$: 'DeactivateModal'};
var author$project$Main$OpenFile = function (a) {
	return {$: 'OpenFile', a: a};
};
var author$project$Main$OpenFileDialog = {$: 'OpenFileDialog'};
var author$project$Main$SetCodelSize = function (a) {
	return {$: 'SetCodelSize', a: a};
};
...
var capitalist$elm_octicons$Octicons$fileMediaPath = 'M6,5 L8,5 L8,7 L6,7 L6,5 L6,5 Z M12,4.5 L12,14 C12,14.55 11.55,15 11,15 L1,15 C0.45,15 0,14.55 0,14 L0,2 C0,1.45 0.45,1 1,1 L8.5,1 L12,4.5 L12,4.5 Z M11,5 L8,2 L1,2 L1,13 L4,8 L6,12 L8,10 L11,13 L11,5 L11,5 Z';
...
var capitalist$elm_octicons$Octicons$fileMedia = A3(capitalist$elm_octicons$Octicons$pathIconWithOptions, capitalist$elm_octicons$Octicons$fileMediaPath, '0 0 12 16', 'fileMedia');
...
var author$project$Main$fileModalView = function (options) {
	return A2(
		author$project$Bulma$modal,
		_List_fromArray(
			[
				elm$html$Html$Attributes$classList(
				_List_fromArray(
					[
						_Utils_Tuple2(author$project$Bulma$isActive, options.isActive)
					]))
			]),
		_List_fromArray(
			[
				A2(
				author$project$Bulma$modalBackground,
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Main$DeactivateModal)
					]),
				_List_Nil),
				A2(
				author$project$Bulma$modalContent,
				_List_Nil,
				_List_fromArray(
					[
						A2(
						author$project$Bulma$box,
						_List_Nil,
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$disabled(options.isDecoding)
									]),
								_List_fromArray(
									[
										A2(
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																_Utils_Tuple2(
																author$project$Bulma$hasName,
																!_Utils_eq(options.file, elm$core$Maybe$Nothing))
															]))
													]),
												_List_fromArray(
													[
														A3(
														author$project$Bulma$fileLabel,
														elm$html$Html$label,
														_List_Nil,
														_List_fromArray(
															[
																A2(
																author$project$Bulma$fileCta,
																_List_fromArray(
																	[
																		elm$html$Html$Events$onClick(author$project$Main$OpenFileDialog)
																	]),
																_List_fromArray(
																	[
																		A2(
																		author$project$Bulma$fileIcon,
																		_List_Nil,
																		_List_fromArray(
																			[
																				capitalist$elm_octicons$Octicons$fileMedia(capitalist$elm_octicons$Octicons$defaultOptions)
																			])),
																		A3(
																		author$project$Bulma$fileLabel,
																		elm$html$Html$span,
																	...
																	A2(
																		...
																		A2(
																			...
																			A2(
																				...
																				author$project$Bulma$fileName(_List_Nil)))),
																	options.file))
															]))
													]))
											])),
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$class(author$project$Bulma$isHorizontal)
											]),
										_List_fromArray(
											[
												A2(
												author$project$Bulma$fieldLabel,
												_List_Nil,
												_List_fromArray(
													[
														A2(
														author$project$Bulma$label,
														_List_Nil,
														_List_fromArray(
															[
																elm$html$Html$text('Codel Size')
															]))
													])),
												A2(
												author$project$Bulma$fieldBody,
												_List_Nil,
												_List_fromArray(
													[
														A2(
														...
														_List_fromArray(
															[
																A2(
																author$project$Bulma$control,
																_List_Nil,
																_List_fromArray(
																	[
																		A2(
																		author$project$Bulma$input,
																		_List_fromArray(
																			[
																				elm$html$Html$Attributes$type_('number'),
																				elm$html$Html$Attributes$value(
																				elm$core$String$fromInt(options.codelSize)),
																				elm$html$Html$Events$onInput(author$project$Main$SetCodelSize)
																			]),
																		_List_Nil)
																	]))
															]))
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																_Utils_Tuple2(author$project$Bulma$isPrimary, true),
																_Utils_Tuple2(author$project$Bulma$isLoading, options.isDecoding)
															])),
														A2(
														elm$core$Maybe$withDefault,
														...
														A2(
															elm$core$Maybe$map,
															A2(elm$core$Basics$composeL, elm$html$Html$Events$onClick, author$project$Main$OpenFile),
															options.file))
													]),
												_List_fromArray(
													[
				...
				A2(
				author$project$Bulma$modalClose,
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Main$DeactivateModal)
					]),
...
var author$project$Bulma$icon = A2(
	author$project$Bulma$builder,
	elm$html$Html$span,
	_List_fromArray(
		[
...
var author$project$Main$iconText = F2(
	function (icon, string) {
		return _List_fromArray(
			[
				A2(
				author$project$Bulma$icon,
				_List_Nil,
				_List_fromArray(
					[
						icon(capitalist$elm_octicons$Octicons$defaultOptions)
					])),
				A2(
				elm$html$Html$span,
				_List_Nil,
...
var author$project$Bulma$hasBackgroundGrey = 'has-background-grey';
var author$project$Image$getColorBlocks = function (_n0) {
	var cbs = _n0.a;
	return cbs;
};
...
var author$project$Color$toString = function (color) {
	switch (color.$) {
		case 'Chromatic':
			var lightness = color.a;
			var hue = color.b;
			var _n1 = function () {
				switch (lightness.$) {
					case 'Light':
						return _Utils_Tuple2('FF', 'C0');
					case 'Normal':
						return _Utils_Tuple2('FF', '00');
					default:
						return _Utils_Tuple2('C0', '00');
				}
			}();
			var hi = _n1.a;
			var lo = _n1.b;
			...
			return '#' + A2(elm$core$String$join, '', hex);
		case 'White':
			return '#FFF';
		case 'Black':
			return '#000';
...
var author$project$Main$codelView = F2(
	function (color, point) {
		return A2(
			elm$svg$Svg$rect,
			_List_fromArray(
...
var author$project$Main$colorBlockView = function (colorBlock) {
	return A2(
		elm$svg$Svg$g,
		_List_Nil,
		A2(
			elm$core$List$map,
			author$project$Main$codelView(colorBlock.color),
			colorBlock.codels));
};
var author$project$Main$mapJoin = F2(
	function (func, separator) {
		return A2(
			elm$core$Basics$composeL,
			elm$core$String$join(separator),
			elm$core$List$map(func));
	});
var elm$core$String$fromFloat = _String_fromNumber;
var author$project$Main$scale = function (value) {
	return 'scale(' + (elm$core$String$fromFloat(value) + ')');
};
var elm$svg$Svg$Attributes$transform = _VirtualDom_attribute('transform');
var author$project$Main$transforms = A2(
	elm$core$Basics$composeL,
	elm$svg$Svg$Attributes$transform,
	elm$core$String$join(' '));
var author$project$Main$translate = function (_n0) {
	var x = _n0.a;
	var y = _n0.b;
...
var author$project$Main$imageView = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$id('imageView'),
							elm$html$Html$Attributes$class(author$project$Bulma$hasBackgroundGrey)
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									elm$svg$Svg$Attributes$width(
									elm$core$String$fromFloat(options.viewBox.width)),
									elm$svg$Svg$Attributes$height(
									elm$core$String$fromFloat(options.viewBox.height)),
									elm$svg$Svg$Attributes$viewBox(
									A3(
										author$project$Main$mapJoin,
										elm$core$String$fromFloat,
										' ',
										_List_fromArray(
											[0.0, 0.0, options.viewBox.width, options.viewBox.height]))),
									...
									mpizenberg$elm_pointer_events$Html$Events$Extra$Wheel$onWheel(author$project$Main$Wheel)
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											author$project$Main$transforms(
											_List_fromArray(
												[
													author$project$Main$translate(
													_Utils_Tuple2(options.viewBox.width / 2, options.viewBox.height / 2)),
													author$project$Main$scale(options.scale),
													author$project$Main$translate(
													_Utils_Tuple2((-options.viewBox.width) / 2, (-options.viewBox.height) / 2)),
													author$project$Main$translate(options.offset)
												]))
										]),
									A2(
										elm$core$List$map,
										author$project$Main$colorBlockView,
										author$project$Image$getColorBlocks(image)))
								]))
						]))
				]));
	});
var author$project$Bulma$navbar = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Bulma$navbarBrand = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Bulma$navbarEnd = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Bulma$navbarItem = F3(
	function (func, attributes, elements) {
		return A2(
			func,
			A2(
...
var author$project$Bulma$navbarMenu = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Main$logo = A2(
	...
	_List_fromArray(
		[
			...
			elm$svg$Svg$Attributes$viewBox('0 0 23 5')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					elm$svg$Svg$Attributes$d('M0,0v5h1v-2h1v-1h-1v-1h1v1h1v-2m1,0v5h3v-1h-2v-1h2v-1h-2v-1h2v-1m1,0v1h1v4h1v-4h1v-1m1,0v5h1v-2h1v2h1v-2h-1v-1h-1v-1h1v1h1v-2m1,0v5h3v-5h-1v4h-1v-4zm4,0v3h2v1h-2v1h3v-3h-2v-1h2v-1')
				]),
			_List_Nil)
		]));
var author$project$Main$textIcon = F2(
	function (icon, string) {
		return _List_fromArray(
			[
				A2(
...
var author$project$Main$navbar = function (_n0) {
	var repositoryUrl = _n0.repositoryUrl;
	return A2(
		author$project$Bulma$navbar,
		_List_Nil,
		_List_fromArray(
			[
				A2(
				author$project$Bulma$container,
				_List_Nil,
				_List_fromArray(
					[
						A2(
						author$project$Bulma$navbarBrand,
						_List_Nil,
						_List_fromArray(
							[
								A3(
								author$project$Bulma$navbarItem,
								elm$html$Html$div,
								_List_Nil,
								_List_fromArray(
						...
						A2(
						author$project$Bulma$navbarMenu,
						_List_Nil,
						_List_fromArray(
							[
								A2(
								author$project$Bulma$navbarEnd,
								_List_Nil,
								_List_fromArray(
									[
										A3(
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$href('http://www.dangermouse.net/esoteric/piet.html'),
												elm$html$Html$Attributes$target('_blank')
											]),
										A2(author$project$Main$textIcon, capitalist$elm_octicons$Octicons$linkExternal, 'Piet language specification')),
										A3(
										author$project$Bulma$navbarItem,
										elm$html$Html$a,
										_List_fromArray(
											[
												elm$html$Html$Attributes$href(repositoryUrl)
											]),
										A2(author$project$Main$iconText, capitalist$elm_octicons$Octicons$markGithub, 'GitHub'))
									]))
							]))
					]))
			]));
};
var author$project$Bulma$delete = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Bulma$notification = A2(
	author$project$Bulma$builder,
	elm$html$Html$div,
	_List_fromArray(
		[
...
var author$project$Bulma$isDanger = 'is-danger';
var author$project$Bulma$isInfo = 'is-info';
var author$project$Bulma$isSuccess = 'is-success';
var author$project$Bulma$isWarning = 'is-warning';
var author$project$Notification$priorityToClassName = function (priority) {
	switch (priority.$) {
		case 'Success':
			return author$project$Bulma$isSuccess;
		case 'Info':
			return author$project$Bulma$isInfo;
		case 'Warning':
			return author$project$Bulma$isWarning;
		default:
			return author$project$Bulma$isDanger;
	}
};
var elm$core$String$lines = _String_lines;
var elm$core$String$trim = _String_trim;
var elm$html$Html$br = _VirtualDom_node('br');
var author$project$Notification$view = F2(
	function (onRemove, manager) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
			...
			A2(
				...
				function (notification) {
					return A2(
						author$project$Bulma$notification,
						_List_fromArray(
							[
								elm$html$Html$Attributes$class(
								author$project$Notification$priorityToClassName(notification.priority))
							]),
						A2(
							elm$core$List$cons,
							A2(
								author$project$Bulma$delete,
								_List_fromArray(
									[
								...
								A2(
									...
									A2(
										...
										A2(
											...
											elm$core$String$lines(notification.message)))))));
				},
				manager.notifications));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(author$project$Notification$view, author$project$Main$RemoveNotification, model.notifications),
				A2(
				author$project$Bulma$section,
				_List_Nil,
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								A2(
								author$project$Bulma$columns,
								_List_Nil,
								_List_fromArray(
									[
										A2(
										author$project$Bulma$column,
										_List_Nil,
										_List_fromArray(
											[
												A2(
													...
													[
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		elm$html$Html$Events$onClick(author$project$Main$ActivateModal)
																	]),
																A2(author$project$Main$iconText, capitalist$elm_octicons$Octicons$fileMedia, 'Open')),
																A2(
																author$project$Bulma$button,
																_List_Nil,
																A2(author$project$Main$iconText, capitalist$elm_octicons$Octicons$circuitBoard, 'Build')),
																A2(
																author$project$Bulma$button,
																_List_Nil,
																A2(author$project$Main$iconText, capitalist$elm_octicons$Octicons$rocket, 'Run'))
															]))
													])),
												A2(
												author$project$Main$imageView,
												{offset: model.offset, scale: model.scale, viewBox: model.viewBox},
												model.image)
											])),
										A2(author$project$Bulma$column, _List_Nil, _List_Nil)
									]))
							]))
					])),
				author$project$Main$fileModalView(model.modal)
			]));
};
var elm$browser$Browser$document = _Browser_document;
var author$project$Main$main = elm$browser$Browser$document(
	{init: author$project$Main$init, subscriptions: author$project$Main$subscriptions, update: author$project$Main$update, view: author$project$Main$view});
_Platform_export({'Main':{'init':author$project$Main$main(elm$json$Json$Decode$value)({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Browser.Dom.Element":{"args":[],"type":"{ scene : { width : Basics.Float, height : Basics.Float }, viewport : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float }, element : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float } }"},"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"},"Html.Events.Extra.Mouse.Event":{"args":[],"type":"{ keys : Html.Events.Extra.Mouse.Keys, button : Html.Events.Extra.Mouse.Button, clientPos : ( Basics.Float, Basics.Float ), offsetPos : ( Basics.Float, Basics.Float ), pagePos : ( Basics.Float, Basics.Float ), screenPos : ( Basics.Float, Basics.Float ) }"},"Html.Events.Extra.Mouse.Keys":{"args":[],"type":"{ alt : Basics.Bool, ctrl : Basics.Bool, shift : Basics.Bool }"},"Html.Events.Extra.Wheel.Event":{"args":[],"type":"{ mouseEvent : Html.Events.Extra.Mouse.Event, deltaY : Basics.Float, deltaMode : Html.Events.Extra.Wheel.DeltaMode }"}},"unions":{"Main.Msg":{"args":[],"tags":{"OpenFileDialog":[],"FileSelected":["File.File"],"OpenFile":["File.File"],"UrlEncoded":["String.String"],"ImageDecoded":["Json.Decode.Value"],"MouseDown":["Html.Events.Extra.Mouse.Event"],"MouseUp":["Html.Events.Extra.Mouse.Event"],"MouseMove":["Html.Events.Extra.Mouse.Event"],"Wheel":["Html.Events.Extra.Wheel.Event"],"SetImageViewSize":["Result.Result Browser.Dom.Error Browser.Dom.Element"],"AddNotification":["Notification.Priority","String.String"],"RemoveNotification":["Basics.Int"],"ActivateModal":[],"DeactivateModal":[],"SetCodelSize":["String.String"]}},"Notification.Priority":{"args":[],"tags":{"Success":[],"Info":[],"Warning":[],"Danger":[]}},"Browser.Dom.Error":{"args":[],"tags":{"NotFound":["String.String"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"File.File":{"args":[],"tags":{"File":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Html.Events.Extra.Mouse.Button":{"args":[],"tags":{"ErrorButton":[],"MainButton":[],"MiddleButton":[],"SecondButton":[],"BackButton":[],"ForwardButton":[]}},"Html.Events.Extra.Wheel.DeltaMode":{"args":[],"tags":{"DeltaPixel":[],"DeltaLine":[],"DeltaPage":[]}}}}})}});
...
var app = _Main.Elm.Main.init({
  flags: {
    repositoryUrl: _package.default.repository.url,
    title: "".concat(_package.default.name, " - ").concat(_package.default.description)
  }
});
...
image.addEventListener("load", function () {
  ...
  app.ports.imageDecoded.send({
    width: width,
    height: height,
    data: data
  });
});
app.ports.decodeImage.subscribe(function (uri) {
  image.src = uri;
}); // vim: set ts=2 sw=2 et:
},{"./Main.elm":"Main.elm","../package.json":"../package.json"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
