...
var author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{error: elm$core$Maybe$Nothing, imageData: elm$core$Maybe$Nothing},
...
var author$project$Main$subscriptions = function (model) {
	return author$project$Ports$imageDecoded(author$project$Main$ImageDecoded);
};
...
var author$project$Main$Codel = F5(
	function (x, y, r, g, b) {
		return {b: b, g: g, r: r, x: x, y: y};
	});
var author$project$Main$ImageData = F3(
...
var author$project$Main$decodeImageData = elm$json$Json$Decode$decodeValue(
	elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2(elm$json$Json$Decode$map, elm$core$Result$Err, elm$json$Json$Decode$string),
				A2(
				elm$json$Json$Decode$map,
				elm$core$Result$Ok,
				A4(
					elm$json$Json$Decode$map3,
					author$project$Main$ImageData,
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var value = msg.a;
				var _n1 = author$project$Main$decodeImageData(value);
				if (_n1.$ === 'Ok') {
					if (_n1.a.$ === 'Ok') {
						var imageData = _n1.a.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									imageData: elm$core$Maybe$Just(imageData)
								}),
							elm$core$Platform$Cmd$none);
					} else {
						var err = _n1.a.a;
...
var author$project$Main$OpenButtonClicked = {$: 'OpenButtonClicked'};
...
var author$project$Main$border = _List_fromArray(
	[
...
var author$project$Main$padding = mdgriffith$elm_ui$Element$padding(8);
...
var author$project$Main$button = function (x) {
	return A2(
		mdgriffith$elm_ui$Element$Input$button,
		A2(
			elm$core$List$append,
			_List_fromArray(
				[author$project$Main$padding]),
...
var author$project$Main$spacing = mdgriffith$elm_ui$Element$spacing(8);
...
var author$project$Main$column = F2(
	function (a, e) {
		return A2(
			...
			A2(elm$core$List$cons, author$project$Main$spacing, a),
			e);
	});
var author$project$Main$joinInt = function (separator) {
	return A2(
...
var author$project$Main$codelView = function (codel) {
	return A2(
		elm$svg$Svg$rect,
		_List_fromArray(
			[
				elm$svg$Svg$Attributes$x(
				elm$core$String$fromInt(codel.x)),
				elm$svg$Svg$Attributes$y(
				elm$core$String$fromInt(codel.y)),
				elm$svg$Svg$Attributes$width('1'),
				elm$svg$Svg$Attributes$height('1'),
				elm$svg$Svg$Attributes$fill(
				'rgb(' + (A2(
					author$project$Main$joinInt,
					',',
					_List_fromArray(
						[codel.r, codel.g, codel.b])) + ')'))
			]),
		_List_Nil);
};
var elm$svg$Svg$svg = elm$svg$Svg$trustedNode('svg');
var elm$svg$Svg$Attributes$viewBox = _VirtualDom_attribute('viewBox');
var author$project$Main$imageDataView = function (imageData) {
	return A2(
		elm$svg$Svg$svg,
		_List_fromArray(
			[
		...
		A2(elm$core$List$map, author$project$Main$codelView, imageData.data));
};
var elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var elm$html$Html$Attributes$style = elm$virtual_dom$VirtualDom$style;
var mdgriffith$elm_ui$Element$htmlAttribute = mdgriffith$elm_ui$Internal$Model$Attr;
var author$project$Main$larger = mdgriffith$elm_ui$Element$htmlAttribute(
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[author$project$Main$larger]),
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$text('Petrus'),
							author$project$Main$button(
							{
								label: mdgriffith$elm_ui$Element$text('OPEN'),
								onPress: elm$core$Maybe$Just(author$project$Main$OpenButtonClicked)
							})
						])),
					A2(
					elm$core$Maybe$withDefault,
					mdgriffith$elm_ui$Element$none,
					A2(elm$core$Maybe$map, mdgriffith$elm_ui$Element$text, model.error)),
					A2(
					elm$core$Maybe$withDefault,
					mdgriffith$elm_ui$Element$none,
					A2(
						...
						A2(
							...
							author$project$Main$imageDataView),
						model.imageData))
				])));
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"OpenButtonClicked":[],"FileSelected":["File.File"],"UrlEncoded":["String.String"],"ImageDecoded":["Json.Encode.Value"]}},"String.String":{"args":[],"tags":{"String":[]}},"File.File":{"args":[],"tags":{"File":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}}}}})}});
  ...
  image.decode().then(function () {
    ...
    for (var y = 0; y < height; ++y) {
      for (var x = 0; x < width; ++x) {
        var _imageData$data$slice = imageData.data.slice((x + y * width) * 4),
            _imageData$data$slice2 = _slicedToArray(_imageData$data$slice, 3),
            r = _imageData$data$slice2[0],
            g = _imageData$data$slice2[1],
            b = _imageData$data$slice2[2];
    ...
    return app.ports.imageDecoded.send(err.message);
  });
}); // vim: set ts=2 sw=2 et:
},{"./Main.elm":"src/Main.elm"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
